...
class Encoder(nn.Module):
    ...
    def forward(self, src_seq, src_mask, src_pos, return_attns=False):

        enc_slf_attn_list = []

        # -- Prepare masks
        slf_attn_mask = get_attn_key_pad_mask(seq_k=src_mask, seq_q=src_mask)
        non_pad_mask = get_non_pad_mask(src_mask)
